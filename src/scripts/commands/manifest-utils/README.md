...
- `manifest-generate <agency>` - Generate/update manifest timestamp and scan for templates for an agency.
- `manifest-generate core` - Generate `core/manifests/manifest.json` from components in `core/`.
