#!/usr/bin/env python3
"""
Update `core/partials/partials-manifest.json` to reflect snippet files present in `core/partials/`.

Usage:
  python3 src/scripts/manifest_utils/manifest-generate-core-partials.py [--dry-run]
